import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, f as useParams, a as useNavigate, u as useLanguage, g as useAuth, P as Phone, M as MapPin, B as Button, i as ue } from "./index-DNcnJBsr.js";
import { M as MotionConfigContext, i as isHTMLElement, u as useConstant, P as PresenceContext, a as usePresence, b as useIsomorphicLayoutEffect, L as LayoutGroupContext, m as motion, B as Badge } from "./badge-szpuQhX_.js";
import { C as Card, b as CardHeader, a as CardContent } from "./card-DItjgxJ4.js";
...
import { l as useMyProfile, m as useRegisterUser, n as useCreateProviderProfile } from "./use-api-Dj0wz_nq.js";
...
import { S as Shield } from "./shield-CFekr-7F.js";
...
function HeroPanel({ lang }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden lg:flex flex-col justify-between p-10 gradient-saffron-accent text-primary-foreground rounded-l-2xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-xl bg-primary-foreground/20 flex items-center justify-center text-xl", children: "🇮🇳" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-lg leading-tight", children: "All India" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/80 text-sm", children: "Help Services" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-3xl leading-tight mb-3", children: lang === "hi" ? "भारत की सेवाएं,\nआपके द्वार" : "Trusted Services\nAcross India" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/80 text-sm leading-relaxed mb-8", children: lang === "hi" ? "हजारों विश्वसनीय सेवा प्रदाताओं से जुड़ें। सरकारी, कानूनी, चिकित्सा और व्यापारिक सेवाएं एक जगह।" : "Connect with thousands of verified service providers. Government, legal, medical, and business services — all in one place." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-3", children: features.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-3 text-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl", children: f.icon }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary-foreground/90", children: lang === "hi" ? f.hi : f.en })
      ] }, f.en)) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 pt-6 border-t border-primary-foreground/20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-3", children: [
      {
        icon: "🔒",
...
function AuthPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-[80vh] flex items-center justify-center px-4 py-10 bg-muted/20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full max-w-4xl", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 rounded-2xl overflow-hidden shadow-elevated border border-border", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(HeroPanel, { lang }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card p-6 sm:p-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:hidden mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TricolorBar, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            step === "login" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 mx-auto rounded-full bg-primary/10 flex items-center justify-center mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Fingerprint, { className: "w-7 h-7 text-primary" }) }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted/40 rounded-lg p-4 flex gap-3", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground leading-relaxed", children: lang === "hi" ? "यह एक सुरक्षित, पासवर्ड-रहित लॉगिन प्रणाली है। आपकी पहचान सुरक्षित रहती है।" : "A secure, password-free login built on blockchain. Your identity stays private." })
                ] })
              ] }),
            ...
            step === "profile" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(StepIndicator, { step }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-6", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-display font-bold text-foreground", children: lang === "hi" ? "अपनी प्रोफाइल पूरी करें" : "Complete Your Profile" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: lang === "hi" ? "आपकी जानकारी सुरक्षित रहेगी" : "Your information is kept private and secure" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "form",
                {
            ...
            step === "provider-details" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(StepIndicator, { step }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 justify-center mb-1", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground text-center mb-6", children: lang === "hi" ? "अपने व्यापार की जानकारी भरें" : "Tell clients about your business" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "form",
                {
            ...
            step === "done" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-6 py-4", children: [
