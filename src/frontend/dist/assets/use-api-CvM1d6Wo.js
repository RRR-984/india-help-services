...
import { w as Subscribable, x as shallowEqualObjects, y as hashKey, z as getDefaultState, A as notifyManager, C as useQueryClient, r as reactExports, D as noop$1, F as shouldThrowError, j as jsxRuntimeExports, G as useActor, H as useQuery } from "./index-CKeR-Ro-.js";
...
function useProviders(filter2, page, pageSize) {
  var _a2;
  const { actor, isFetching } = useActor();
  return useQuery({
    queryKey: [
      "providers",
      (_a2 = filter2.categoryId) == null ? void 0 : _a2.toString(),
      filter2.state,
      filter2.city,
      page.toString()
    ],
    queryFn: () => actor.listProviders(filter2, page, pageSize),
    enabled: !!actor && !isFetching
  });
}
function useProvider(id2) {
  const { actor, isFetching } = useActor();
  return useQuery({
    queryKey: ["provider", id2 == null ? void 0 : id2.toString()],
    queryFn: () => actor.getProvider(id2),
...
function useUpdateCategory() {
  ...
  const qc = useQueryClient();
  return useMutation({
    mutationFn: ({ id: id2, input }) => actor.updateCategory(id2, input),
    onSuccess: () => qc.invalidateQueries({ queryKey: ["categories"] })
  });
}
function useDeleteCategory() {
  ...
  const qc = useQueryClient();
  return useMutation({
    mutationFn: (id2) => actor.deleteCategory(id2),
    onSuccess: () => qc.invalidateQueries({ queryKey: ["categories"] })
  });
}
function useSetCategoryActive() {
  ...
  const qc = useQueryClient();
  return useMutation({
    mutationFn: ({ id: id2, isActive }) => actor.setCategoryActive(id2, isActive),
    onSuccess: () => qc.invalidateQueries({ queryKey: ["categories"] })
  });
}
function useApproveProvider() {
  ...
  const qc = useQueryClient();
  return useMutation({
    mutationFn: (id2) => actor.approveProvider(id2),
...
function useDisableProvider() {
  ...
  const qc = useQueryClient();
  return useMutation({
    mutationFn: (id2) => actor.disableProvider(id2),
    onSuccess: () => qc.invalidateQueries({ queryKey: ["providers"] })
  });
}
...
export {
  useUsers as A,
  useSetUserRole as B,
  useCreateCategory as C,
  useUpdateCategory as D,
  ...
  useProvider as d,
  useReviewsByProvider as e,
  useSubmitInquiry as f,
  useAddReview as g,
  useConstant as h,
  isHTMLElement as i,
  usePresence as j,
  ...
  useMyProfile as l,
  motion as m,
  useRegisterUser as n,
  useCreateProviderProfile as o,
  useMyInquiries as p,
  useMyReviews as q,
  useMyProviderProfile as r,
  useInquiriesByProvider as s,
  useUpdateUserProfile as t,
  useCategories as u,
  useAllCategories as v,
  useDeleteCategory as w,
  useSetCategoryActive as x,
  useApproveProvider as y,
  useDisableProvider as z
};
